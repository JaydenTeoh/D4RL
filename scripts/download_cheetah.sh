...
python scripts/generation/mujoco/stitch_dataset.py halfcheetah_expert-v2.hdf5 halfcheetah_medium-v2.hdf5 halfcheetah_random-v2.hdf5 --output_file halfcheetah_random_medium_expert.hdf5 
python scripts/generation/mujoco/stitch_dataset.py halfcheetah_medium-v2.hdf5 halfcheetah_random-v2.hdf5 --output_file halfcheetah_random_medium.hdf5
# i have checked
