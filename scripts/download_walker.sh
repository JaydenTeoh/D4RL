...
python scripts/generation/mujoco/stitch_dataset.py walker2d_expert-v2.hdf5 walker2d_medium-v2.hdf5 walker2d_random-v2.hdf5 --output_file walker2d_random_medium_expert.hdf5 
python scripts/generation/mujoco/stitch_dataset.py walker2d_medium-v2.hdf5 walker2d_random-v2.hdf5 --output_file walker2d_random_medium.hdf5
# i have checked
