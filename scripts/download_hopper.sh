...
python scripts/generation/mujoco/stitch_dataset.py hopper_expert-v2.hdf5 hopper_medium-v2.hdf5 hopper_random-v2.hdf5 --output_file hopper_random_medium_expert.hdf5 
python scripts/generation/mujoco/stitch_dataset.py hopper_medium-v2.hdf5 hopper_random-v2.hdf5 --output_file hopper_random_medium.hdf5
# i have checked
